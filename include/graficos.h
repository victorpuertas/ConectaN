...
/**
  ...
  * @param ancho Nmero de columnas (en p�eles) de la ventana a crear.
  * @param alto Nmero de filas (en p�eles) de la ventana a crear.
  * @param titulo Cadena con el t�ulo de la ventana a crear.
...
/**
  ...
  * @return  Las filas (alto) de la ventana en p�eles
...
/**
  ...
  * @return  Las columnas (ancho) de la ventana en p�eles
  * @pre Se ha creado una ventana previamente con CrearVentana
  */
int ColumnasVentana();
...
/**
  * @brief Dibuja una l�ea desde (@a x1,@a y1) a (@a x2,@a y2) de color (@a r, @a g, @a b)
  ...
  * @pre Se ha creado una ventana previamente con CrearVentana
  * @pre Los puntos (@a x1,@a y1) (@a x2,@a y2) est� dentro de la ventana
  * @pre Los componentes de color est� en en rango [0,255]
  */
...
/**
  ...
  * @param b componente azul del color
  * @pre Se ha creado una ventana previamente con CrearVentana
  * @pre Los puntos que dibujan la circunferencia est� dentro de la ventana
  * @pre Los componentes de color est� en en rango [0,255]
  * @see CirculoR
  */
...
/**
  * @brief Dibuja un rect�gulo definido por las esquinas (@a x1,@a y1) a (@a x2,@a y2) de color (@a r, @a g, @a b)
  * @param x1 columna del primer punto
  * @param y1 fila del primer punto
  * @param x2 columna del segundo punto
  * @param y2 fila del segundo punto
...
/**
  ...
  * @param b componente azul del color
  * @pre Se ha creado una ventana previamente con CrearVentana
  * @pre Los puntos que dibujan la elipse est� dentro de la ventana
  * @pre Los componentes de color est� en en rango [0,255]
  * @see ElipseR
  */
...
/**
  * @brief Dibuja un rect�gulo relleno
  * @param x1 columna del primer punto
  * @param y1 fila del primer punto
  * @param x2 columna del segundo punto
  * @param y2 fila del segundo punto
...
/**
  * @brief Dibuja un c�culo relleno
  * @param x columna del punto centro de la circunferencia
  * @param y fila del punto centro de la circunferencia
  * @param rad radio de la circunferencia
  * @param r componente rojo del color
...
/**
  ...
  * @param b componente azul del color
  * @pre Se ha creado una ventana previamente con CrearVentana
  * @pre Los puntos que dibujan el texto est� dentro de la ventana
  * @pre Los componentes de color est� en en rango [0,255]
  * @post El texto se dibuja en el rect�gulo de alto 8 y ancho longitud(c)*8 y con esquina superior
...
/**
  ...
  * @post Si ocurre un error, se describe el problema en la salida est�dar de error
...
/**
  * @brief Obtener las dimensiones (filas y columnas) de una imagen que est�almacenada en un fichero
  * @param imagen cadena que contiene el nombre del fichero
  * @param x tama� en columnas de la imagen
  * @param y tama� en filas de la imagen
  * @see LeerImagenBMP, DimensionesBMP, DibujarImagenBMP
  */
...
/**
  * @brief Dibuja en la ventana gr�ica, a partir de las coordenadas (@a x, @a y), la imagen almacenada en @a img
  ...
  * @pre La imagen ha sido previamente cargada con LeerImagenBMP
  * @pre La imagen debe caber completa en el �ea delimitada por la ventana
  * @see LeerImagenBMP, DimensionesBMP, DibujarImagenBMP
  */
